  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView contentContainerStyle={{padding: 20}}>
        <View className="mb-8">
          <Text className="text-2xl font-semibold mb-3 text-gray-900">Understanding your rating</Text>
        ...
        <View className="mb-8">
          {ratingFactors.map((factor, index) => (
            <View key={index} className="flex-row items-center mb-6 bg-white rounded-xl p-4 shadow-sm">
              <View className="mr-4">
                <DeliveryPersonIcon />
              </View>
              <View className="flex-1">
                <Text className="text-lg font-semibold mb-1.5 text-gray-900">{factor.title}</Text>
                <Text className="text-sm leading-5 text-gray-600">{factor.description}</Text>
              </View>
            </View>
          ))}
        </View>
        ...
        <View className="mb-8">
          <Text className="text-xl font-semibold mb-2 text-gray-900">How is your rating calculated</Text>
          <Text className="text-base leading-6 text-gray-600">
